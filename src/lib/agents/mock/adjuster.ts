...
const MESSAGES: Record<TriggerCategory, Record<Persona, string[]>> = {
  entry: {
    ...
    strict: [
      '오늘 첫 미션, 지금 시작하세요. 미루지 않습니다.',
      '핑계는 그만. 책상 앞으로, 10분이면 됩니다.',
      '첫 항목부터 바로 갑니다. 시작하세요.',
    ],
  },
  milestone: {
    gentle: [
      '오늘 할 일 전부 끝냈어요! 정말 잘했어요.',
      '구간 하나 완료! 이 페이스 정말 좋아요.',
      '오늘치 미션 클리어. 내일도 같이 가요.',
    ],
    strict: [
      '오늘 할당량 완수. 이게 기본입니다 — 내일도 그대로.',
      '구간 통과. 여기서 느슨해지면 의미 없습니다.',
      '완료 확인. 페이스 유지하세요. 봐주는 건 없습니다.',
    ],
  },
  stats: {
    gentle: [
